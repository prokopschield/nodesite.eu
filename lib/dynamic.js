...
function dynamic(domain) {
    ...
    const cachedir = path_1.default.resolve('.', '.dyn-cache-dir');
    async function f(p) {
        try {
            if (!fs_1.default.existsSync(p))
                return false;
            if (p.includes(cachedir))
                return false;
            ...
            if ((ext === '.ts') || (ext === '.js')) {
                ...
                if (!fs_1.default.existsSync(cp) || ((await fs_1.default.promises.readFile(cp)).toString('utf8') !== dat.toString('utf8'))) {
