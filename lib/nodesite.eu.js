...
exports.insSocketIO = exports.solved = exports.requestHandlerProxy = exports.open_file_options = exports.deferred_challenges = exports.blake = exports.rawwrite = exports.IOListener = exports.redo = exports.sites = exports.init = exports.NodeSiteClient = exports.io = exports.create = exports.proxy = void 0;
...
let insSocketIO;
exports.insSocketIO = insSocketIO;
let sites = {};
exports.sites = sites;
...
let init = async function initializeSocket() {
    ...
    exports.insSocketIO = insSocketIO = libSocketIO('wss://nodesite.eu:' + port);
    ...
    insSocketIO.on('invalid_response', (...args) => console.log('Server regected response!', args));
